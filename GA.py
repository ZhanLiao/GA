...
solution, F04values, values = main()
...
# 保存数据
dataframe = pd.DataFrame({'GA': values})
# dataframe.to_csv(r"GAresult.csv", sep=',', index=False)
# dataframe.to_csv(r"GAresult-F02.csv", sep=',', index=False)
# dataframe.to_csv(r"GAresult-F03.csv", sep=',', index=False)
# dataframe.to_csv(r"GAresult-F04.csv", sep=',', index=False)
# dataframe.to_csv(r"GAresult-F05.csv", sep=',', index=False)
dataframe.to_csv(r"GAresult-F06.csv", sep=',', index=False)